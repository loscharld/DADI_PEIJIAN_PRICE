...
def statistics_pre():
    ...
    df4['coef_nation'] = df4.apply(lambda x: (x['REFERENCE'] - x['national_mean']) / x['national_mean'], axis=1)
    df4['coef'] = df4.apply(lambda x: (x['REFERENCE'] - x['mean']) / x['mean'], axis=1)
